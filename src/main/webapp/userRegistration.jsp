...
<% 
	...
	Connection con = DriverManager.getConnection("jdbc:mysql://loacalhost:3306/artiuser?useSSL=false&requireSSL=false&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "arti@artimysqljava", "A@Rt1CoR3!");
